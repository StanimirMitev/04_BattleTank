...
AProjectile::AProjectile()
{
	...
	LaunchBlast = CreateDefaultSubobject<UParticleSystemComponent>(FName("Launc Blast"));
	...
	ExplosionForce = CreateDefaultSubobject<URadialForceComponent>(FName("Explostion"));
